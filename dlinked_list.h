 ...
 */
void *dlinked_peek_tail(const dlinked_list *list);
 ...
 */
void *dlinked_get_value(const dlinked_list *list, size_t index);
 ...
 */
void dlink_map(const dlinked_list *list, void(*func)(void *));
